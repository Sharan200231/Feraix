...
export default function ContactHero() {
  return (
    <section className="relative min-h-[65vh] flex items-center justify-center pt-32 pb-20 overflow-hidden">
      {/* Background Image */}
      ...
      <div className="relative z-10 container mx-auto px-6 text-center max-w-4xl">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
          <button className="px-10 py-4 bg-primary text-white font-bold rounded-full hover:bg-primary/90 hover:scale-105 transition-all shadow-[0_0_15px_rgba(59,130,246,0.3)]">
            Send a Message
          </button>
          <button className="px-10 py-4 bg-transparent border border-white/20 text-white font-bold rounded-full hover:bg-white/5 transition-all">
