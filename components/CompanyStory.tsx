  ...
  return (
    <section className="py-12 sm:py-24 overflow-hidden">
      <div className="mx-auto">
        <div className="relative w-full aspect-[4/3] sm:aspect-[16/9] lg:aspect-[21/9] overflow-hidden border-y border-white/5 shadow-2xl">
          <Image
          ...
          <div className="absolute inset-0  flex items-center justify-center">
            <div className="text-center max-w-4xl px-4 sm:px-6">
              <p className="text-primary font-bold tracking-[0.2em] text-[10px] sm:text-xs uppercase mb-3 sm:mb-4">Our Story</p>
              <h2 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 sm:mb-8">A Technology-Driven Company</h2>
              <p className="text-gray-300 text-sm sm:text-lg md:text-xl leading-relaxed max-w-2xl mx-auto hidden sm:block">
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 mt-12 sm:mt-20">
            {/* Vision Card */}
            <div className="p-8 sm:p-12 rounded-[24px] sm:rounded-[40px] bg-[#0B0F1A] border border-white/5 hover:border-primary/20 transition-all group">
