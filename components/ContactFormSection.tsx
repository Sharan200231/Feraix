              ...
              <div className="space-y-8">
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm leading-relaxed">
                      Feraix Technology HQ <br />
                      Building 4, Dubai Internet City <br />
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm mb-1">General: hello@feraix.com</p>
                    <p className="text-gray-400 text-sm">Support: support@feraix.com</p>
                  </div>
                </div>
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm mb-1">Main: +971 4 123 4567</p>
                    <p className="text-gray-400 text-sm">Sales: +971 4 123 4568</p>
                  </div>
                </div>
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm mb-1">Monday - Friday: 9:00 AM - 6:00 PM (GST)</p>
            ...
            <div className="p-6 sm:p-10 lg:p-12 rounded-[24px] sm:rounded-[40px] bg-[#0B0F1A] border border-white/5">
              ...
              <form className="space-y-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <label htmlFor="privacy" className="text-xs text-gray-500">I agree to the <Link href="#" className="text-primary hover:underline">Privacy Policy</Link> and consent to Feraix processing my personal data.</label>
                </div>

                <button type="submit" className="w-fit flex items-center gap-3 bg-primary text-white font-bold rounded-full px-10 py-4 hover:bg-primary/90 transition-all shadow-[0_0_15px_rgba(59,130,246,0.3)]">
                  Send Message
