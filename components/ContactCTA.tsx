...
export default function ContactCTA() {
  return (
    <section className="py-16 sm:py-24 bg-background relative overflow-hidden">
      {/* Background glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] sm:w-[600px] h-[200px] sm:h-[300px] bg-primary/10 rounded-full blur-[120px] -z-10"></div>
      ...
      <div className="container mx-auto px-4 sm:px-6 text-center">
        ...
        <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4 sm:mb-6">Prefer to talk it out?</h2>
        <p className="text-gray-400 text-base sm:text-lg mb-8 sm:mb-12 max-w-2xl mx-auto leading-relaxed">
