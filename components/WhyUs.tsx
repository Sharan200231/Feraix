        ...
        <div className="relative w-full  mx-auto overflow-hidden border border-blue-500/30 shadow-[0_0_60px_rgba(59,130,246,0.15)]">
          ...
          <div className="relative z-10 px-8 py-16 md:px-16 md:py-24 flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="flex-1">
              <div className="inline-block px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-primary text-xs font-bold mb-6 tracking-widest uppercase">
                Why Choose Feraix
              </div>
              ...
              <div className="space-y-4 mb-12">
                {listItems.map((item, i) => (
                  <div key={i} className="flex items-center gap-4 p-5 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all group backdrop-blur-md">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-6">
                <button className="px-10 py-4 bg-primary text-background font-bold rounded-full hover:scale-105 transition-all shadow-[0_0_30px_rgba(251,221,8,0.3)] flex items-center gap-2 text-lg">
                  START FREE TRIAL
                  <span className="text-xl">›</span>
                </button>
                <button className="px-10 py-4 bg-white/5 border border-white/10 text-white font-bold rounded-full hover:bg-white/10 transition-all flex items-center gap-2 backdrop-blur-md text-lg">
            ...
            <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-6 w-full">
              {statCards.map((stat, i) => (
                <div key={i} className={`p-10 rounded-[2rem] border border-white/10 ${stat.color} backdrop-blur-xl flex flex-col items-center text-center group hover:-translate-y-2 transition-all duration-500 shadow-xl`}>
